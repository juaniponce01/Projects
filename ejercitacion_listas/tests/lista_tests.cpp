...
TEST(lista_test, test_agregar_varios_elementos_atras_y_adelante) {
    Lista l;
    l.agregarAtras(42);
    l.agregarAtras(43);
    l.agregarAdelante(41);
...
TEST(lista_test, test_eliminar_elementos_atras) {
    Lista l;
    l.agregarAtras(42);
    l.agregarAtras(43);
    l.agregarAtras(44);
...
TEST(lista_test, test_eliminar_elementos_atras_y_adelante) {
    Lista l;
    l.agregarAdelante(43);
    l.agregarAtras(44);
    l.agregarAdelante(42);
    ...
    ASSERT_EQ(l.iesimo(0), 42);
    ASSERT_EQ(l.iesimo(1), 44);
    ASSERT_EQ(l.iesimo(2), 46);

    l.eliminar(0);
    l.eliminar(0);

    ASSERT_EQ(l.longitud(), 1);
    ASSERT_EQ(l.iesimo(0), 46);
...
TEST(lista_test, test_constructor_por_copia_atras) {
    Lista l;
    l.agregarAtras(42);
    l.agregarAtras(43);
    l.agregarAtras(44);
...
TEST(lista_test, test_constructor_por_copia_adelante) {
    Lista l;
